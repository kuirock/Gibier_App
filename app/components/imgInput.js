...
const ImgInput = (props) => {
    ...
    const handleClick = async() => {
        try{
            ...
            data.append("upload_preset", "hokkaido-gibier")
            data.append("cloud_name","dnqr3ww80")
            const response= await fetch("https://api.cloudinary.com/v1_1/dnqr3ww80/image/upload", {method: "POST", body: data})
